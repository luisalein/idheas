 <div class="six columns">		
	        <label for="pais">País</label>
	        	...
	        	<?php if($tipo == 1):?>
		            <select id="datosDeNacimiento_paisesCatalogo_paisId" name="datosDeNacimiento_paisesCatalogo_paisId" onclick="changeTest(1)" onkeypress="changeTest(1)">						
		                    <option></option>
		         ...
		         <?php if($tipo == 2):?> 
		         	...
		         	<select id="infoMigratoria_lugarOrigenPaisId" name="infoMigratoria_lugarOrigenPaisId"  onclick="changeTest(1)" onkeypress="changeTest(1)">						
		                    <option></option>
	             ...
	             <?php if($tipo==3 ):?>
	             	<?php if(isset($direccionExtra)):?>
	             		<select id="direccionActor_paisesCatalogo_paisId" name="direccionActor_paisesCatalogo_paisId" onclick="changeTest(1)" onkeypress="changeTest(1)">						
			                    <option></option>
        ...
        <div class="six columns">
            ...
            <?php if($tipo == 1):?>
	            	<?php if(isset($datosActor['datosDeNacimiento']['estadosCatalogo_estadoId'])):?>
		                <select id="datosDeNacimiento_estadosCatalogo_estadoId"    name="datosDeNacimiento_estadosCatalogo_estadoId"  onclick="changeTest(2)" onkeypress="changeTest(2)">						
	                ...
	                <?php else:?>
	                	<select id="datosDeNacimiento_estadosCatalogo_estadoId"  disabled="disabled"  name="datosDeNacimiento_estadosCatalogo_estadoId" onclick="changeTest(2)"  onkeypress="changeTest(2)">						
            ...
            <?php if($tipo == 2):?>
            	<?php if(isset($datosActor['infoMigratoria']['lugarOrigenEstadoId'])):?>
		                <select id="infoMigratoria_lugarOrigenEstadoId"    name="infoMigratoria_lugarOrigenEstadoId" onclick="changeTest(2)"  onkeypress="changeTest(2)">						
	                ...
	                <?php else:?>
	                	<select id="infoMigratoria_lugarOrigenEstadoId"  disabled="disabled"  name="infoMigratoria_lugarOrigenEstadoId" onclick="changeTest(2)"  onkeypress="changeTest(2)">						
		    ...
		    <?php if($tipo==3):?>
		    	<?php if(isset($direccionExtra)):?>
		    		<?php if(isset($datosActor['direccionActor'])):?>
		                <select id="direccionActor_estadosCatalogo_estadoId"  name="direccionActor_estadosCatalogo_estadoId" onclick="changeTest(2)"  onkeypress="changeTest(2)">
		            ...
		            <?php else:?>  
		            	<select id="direccionActor_estadosCatalogo_estadoId" disabled="disabled" name="direccionActor_estadosCatalogo_estadoId" onclick="changeTest(2)"  onkeypress="changeTest(2)">
            ...
            <?php endif;?>
             <?php if($tipo ==4):?>
             	<?php if(isset($derechoAfectado['estadosCatalogo_estadoId'])):?>
		            		<select id="derechoAfectado_estadosCatalogo_estadoId"  name="derechoAfectado_estadosCatalogo_estadoId" onclick="changeTest(2)"  onkeypress="changeTest(2)">						
			                       <?php foreach($catalogos['estadosCatalogo'] as $key => $item): ?> <!--muestra los estados civiles-->
		    		...
		    		<?php else:?>  
		            	<select id="derechoAfectado_estadosCatalogo_estadoId"  disabled="disabled"  name="derechoAfectado_estadosCatalogo_estadoId" onclick="changeTest(2)"  onkeypress="changeTest(2)">						
