	...
	<br/>
			...
			<div  id="pestania" data-collapse>
				...
				<div class="twelve columns">
					...
					<textarea rows="10" cols="100" <?=(isset($relaciones) ? 'value="'.$relaciones['comentarios'].'"' : ''); ?> id="TextoRelActoresColectivo" style="width: 400px; height: 200px" wrap="hard"  name="comentarios"></textarea>
			   </div>	  
