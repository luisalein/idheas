...
<body>
	...
	<input type="hidden"  id="relacionActores_tipoRelacionInd" name="relacionActoresId" <?php (isset($relaciones['relacionActoresId'])) ? 'value="'.$relaciones['relacionActoresId'].'"' : '' ;?> />
	...
	<div class="twelve columns">
		...
		<label for="TipoRel">Tipo de relación</label>
			<?php if($catalogos['listaTodosActores'][$actorId]['tipoActorId']<3){ ?>
