 <div class="ten columns">		
	        <label for="pais">País</label>
			         	<select id="direccionActor_paisesCatalogo_paisId" name="direccionActor_paisesCatalogo_paisId" onkeypress="changeTest2(1)">						
			                    <option></option>
        ...
        <div class="ten columns">
            ...
            <select id="direccionActor_estadosCatalogo_estadoId"  disabled="disabled"  name="direccionActor_estadosCatalogo_estadoId"  onkeypress="changeTest2(2)">						
