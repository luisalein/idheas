...
<fieldset >
    ...
    <div class="twelve columns"> 
        <div class="six columns">
            ...
            <option onclick="notasCatalogos('<?=$item['notas']; ?>','infoGralActores_tipoActorColectivoId','2')" value="<?=$item['tipoActorColectivoId']?>" <?=($datosActor['infoGralActores']['tipoActorColectivoId'] == $item['tipoActorColectivoId']) ? 'selected="selected"' : '' ; ?> > <?=$item['descripcion']?></option>
            <?php endforeach; } else { ?>
            <?php foreach($catalogos['tipoActorColectivo'] as $key => $item):?> <!--muestra los estados civiles-->
            <option onclick="notasCatalogos('<?=$item['notas']; ?>','infoGralActores_tipoActorColectivoId','2')" value="<?=$item['tipoActorColectivoId']; ?>"><?=$item['descripcion']; ?></option>
            <?php endforeach; } ?>
        ...
        <div class="six columns">
            ...
            <?php if($item['tipoActorId'] == 2){ ?>
                <option onclick="notasCatalogos('<?=$item['notas']; ?>','infoGralActores_actividad','2')" value="<?=$item['ocupacionId']?>" <?=($datosActor['infoGralActores']['actividad'] == $item['ocupacionId']) ? 'selected="selected"' : '' ; ?> > <?=$item['descripcion']?></option>
             <?php } ?>
            <?php endforeach; } else { ?>
            <?php foreach($catalogos['ocupacionesCatalogo'] as $key => $item):?> <!--muestra los estados civiles-->
            <?php if($item['tipoActorId'] == 2){ ?>
                <option onclick="notasCatalogos('<?=$item['notas']; ?>','infoGralActores_actividad','2')" value="<?=$item['ocupacionId']; ?>"><?=$item['descripcion']; ?></option>
             <?php } ?>
            <?php endforeach; } ?>
