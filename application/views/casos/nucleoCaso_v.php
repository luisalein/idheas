	  				...
	  				<table class="twelve columns">
			            ...
			            <tbody>
			              ...
			              <?php	if (isset($inter['casosActorReceptor'])) {
			                ...
			                <td><span id="descho_fichaId"><?=(isset($inter['receptorId']) && ($inter['receptorId']>0)) ? $catalogos['listaTodosActores'][$inter['receptorId']]['nombre']." ".$catalogos['listaTodosActores'][$inter['receptorId']]['apellidosSiglas'] : ''; ?><?=(isset($inter['tipoRelacionInterventor']) && ($inter['tipoRelacionInterventor']>0) &&(isset($catalogos['relacionesActoresCatalogo'][$inter['tipoRelacionInterventor']]))) ? ' ('.$catalogos['relacionActoresCatalogo'][$catalogos['relacionesActoresCatalogo'][$inter['tipoRelacionInterventor']]['tipoRelacionId']]['Nivel2'].') '.$catalogos['listaTodosActores'][$catalogos['relacionesActoresCatalogo'][$inter['tipoRelacionInterventor']]['actorRelacionadoId']]['nombre']." ".$catalogos['listaTodosActores'][$catalogos['relacionesActoresCatalogo'][$inter['tipoRelacionInterventor']]['actorRelacionadoId']]['apellidosSiglas'] : ''; ?></span></td>
			                <td><span id="descho_fichaId"><?=(isset($inter['interventorId']) && ($inter['interventorId']>0)) ?  $catalogos['listaTodosActores'][$inter['interventorId']]['nombre']." ".$catalogos['listaTodosActores'][$inter['interventorId']]['apellidosSiglas'] : ''; ?><?=(isset($inter['tipoRelacionReceptor']) && ($inter['tipoRelacionReceptor']>0) &&(isset($catalogos['relacionesActoresCatalogo'][$inter['tipoRelacionReceptor']]))) ? ' ('.$catalogos['relacionActoresCatalogo'][$catalogos['relacionesActoresCatalogo'][$inter['tipoRelacionReceptor']]['tipoRelacionId']]['Nivel2'].') '.$catalogos['listaTodosActores'][$catalogos['relacionesActoresCatalogo'][$inter['tipoRelacionReceptor']]['actorRelacionadoId']]['nombre']." ".$catalogos['listaTodosActores'][$catalogos['relacionesActoresCatalogo'][$inter['tipoRelacionReceptor']]['actorRelacionadoId']]['apellidosSiglas'] : ''; ?></span></td>
