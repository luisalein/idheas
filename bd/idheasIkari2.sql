...
CREATE  TABLE IF NOT EXISTS `idheasIkari`.`fuenteInfoPersonal` (
  ...
  INDEX `fk_fuenteInfoPersonal_casos1` (`casos_casoId` ASC) ,
  INDEX `fk_fuenteInfoPersonal_tipoFuenteCatalogo1` (`tipoFuenteCatalogo_tipoFuenteId` ASC) ,
  INDEX `fk_fuenteInfoPersonal_idiomaCatalogo1` (`idiomaCatalogo_idiomaId` ASC) ,
  INDEX `fk_fuenteInfoPersonal_nivelConfiabilidadCatalogo1` (`nivelConfiabilidadCatalogo_nivelConfiabilidadId` ASC) ,
...
CREATE  TABLE IF NOT EXISTS `idheasIkari`.`relacionActores` (
  ...
  INDEX `fk_relacionActores_actores1` (`actores_actorId` ASC) ,
...
CREATE  TABLE IF NOT EXISTS `idheasIkari`.`tipoFuenteDocumental` (
  ...
  `infoAdiocional` VARCHAR(3000) NULL ,
  ...
  INDEX `fk_tipoFuenteDocumental_casos1` (`casos_casoId` ASC) ,
  INDEX `fk_tipoFuenteDocumental_tipoFuenteCatalogo1` (`tipoFuenteCatalogo_tipoFuenteId` ASC) ,
  INDEX `fk_tipoFuenteDocumental_idiomaCatalogo1` (`idiomaCatalogo_idiomaId` ASC) ,
  INDEX `fk_tipoFuenteDocumental_nivelConfiabilidadCatalogo1` (`nivelConfiabilidadCatalogo_nivelConfiabilidadId` ASC) ,
